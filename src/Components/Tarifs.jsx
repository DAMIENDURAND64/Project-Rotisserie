    ...
    <div className=" py-4">
      <div className="flex flex-col items-center gap-y-6">
        ...
        <ul className=" py-10 bg-[#906948] bg-opacity-80 text-white md:text-lg rounded-md flex flex-col justify-between items-center w-11/12 mb-4 md:w-3/4 md:bg-opacity-80">
          <li className="my-2">Poulet Iparla : 22€ / pièce</li>
          <li className="my-2">Poulet Label Rouge : 22€ / pièce</li>
          <li className="my-2">Echine de Porc Manex : 24.90€ / Kg</li>
          <li className="my-2">Jarret sans os de Porc Manex : 15.90€ / Kg</li>
          <li className="my-2">
